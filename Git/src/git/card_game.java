...
public class card_game extends JFrame implements ActionListener {
	...
	static int stop_time; // 버튼이나 이미지를 1초후에 사라지게 할 변수
	...
	public card_game() {
		...
		for (i = 0; i < 16; i++) {
			frm.add(btn[i] = new JButton("1")); // 프레임안에 버튼을 넣음
	...
	public static void finish() {
		JDialog dia = new JDialog(frm, "게임종료");
		dia.setBounds(700, 400, 300, 200);
		dia.setVisible(true);

		JLabel finish = new JLabel("전부 맞추셨습니다. 축하합니다!", JLabel.CENTER);
